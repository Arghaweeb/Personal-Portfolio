...
const About = () => {
  return (
    <div id="about" className="min-h-screen flex flex-col items-center justify-start py-20">
      <Heading text={'About Me'} />
      <div className="w-full flex items-center justify-center gap-8 md:justify-center mt-16">
        <Image
          src={'/about-me.png'}
          alt="About Image"
          width={400}
        ...
        <div className="relative max-w-[800px] rounded-xl bg-zinc-100 p-5 text-justify dark:bg-zinc-700 transition-colors">
          ...
          <p className="text-lg font-light text-gray-700 first-letter:pl-2 lg:text-[16px] sm:text-[14px] dark:text-white">
            {aboutText}
          </p>
          <a
            href="/Arghacv.pdf"
      ...
      <div className="mt-20 w-full flex flex-wrap items-center justify-center gap-x-12 gap-y-10">
